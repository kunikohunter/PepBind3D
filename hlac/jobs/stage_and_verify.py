...
<CLUSTER>/hlac_generator/output/IEDB_data/<allele>/output/...,
verifies each stamps REMARK 220 VERSION 2024.09+release.06b3cf8, and stages it at
<CLUSTER>/hlac_production/pdb/<COMPACT>/<peptide>/<peptide>_input.pdb
...
GEN_ROOT = "<CLUSTER>/hlac_generator/output/IEDB_data"
STAGE_ROOT = "<CLUSTER>/hlac_production/pdb"
TARGETS_CSV = "<HOME>/main_project/scripts/hla_c/hlac_threading_targets.csv"
