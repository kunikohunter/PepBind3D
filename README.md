...
- Released dataset: `<HOME>/main_project/data/IEDB_data_clean/huggingface/`
- Local PDB store (one folder per peptide): `<HOME>/main_project/data/IEDB_data_clean/pdb/{allele}/{peptide}/`
- Template PDB database: `<HOME>/Data/MHC_database/templates/`
- Validation outputs: `<HOME>/main_project/data/IEDB_data_clean/IEDB_validation/`
